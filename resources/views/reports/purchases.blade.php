...
<div class="d-flex justify-content-between align-items-center mb-3 no-print">
    <div>
        <h5 class="mb-0"><i class="bi bi-file-earmark-bar-graph"></i> Laporan Pembelian</h5>
        <small class="text-muted">Rekap transaksi pembelian dari supplier berdasarkan rentang tanggal.</small>
    </div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card stat-card shadow-sm">
            <div class="card-body">
                ...
                <h4 class="fw-bold mb-0">{{ $summary['total_pembelian'] }}</h4>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
        <div class="card stat-card shadow-sm">
            <div class="card-body">
                ...
                <h4 class="fw-bold mb-0">Rp {{ number_format($summary['total_belanja'], 0, ',', '.') }}</h4>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
...
{{-- ===== Detail Transaksi Pembelian (klik baris untuk lihat item) ===== --}}
<div class="card shadow-sm border-0 mb-3">
    <div class="card-body">
        <h6 class="fw-semibold mb-3"><i class="bi bi-list-check"></i> Detail Pembelian</h6>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    @forelse($purchases as $p)
                        <tr class="report-row" style="cursor:pointer" data-bs-toggle="collapse" data-bs-target="#detail-{{ $p->id }}">
                        ...
                        <tr class="collapse" id="detail-{{ $p->id }}">
                            ...
                            <td colspan="7" class="bg-light">
                                ...
                                <div class="d-flex justify-content-between small text-muted">
                                    ...
                                    <a href="{{ route('purchases.show', $p) }}" class="no-print">
                ...
                <tfoot>
                    <tr class="table-light">
                        ...
                        <th class="text-end">Rp {{ number_format($summary['total_belanja'], 0, ',', '.') }}</th>
                    </tr>
                </tfoot>
                @endif
            </table>
...
<div class="card shadow-sm border-0 mb-3">
    <div class="card-body">
        <h6 class="fw-semibold mb-3"><i class="bi bi-box-seam"></i> Rekap Produk Dibeli</h6>
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead>
                    <tr>
...
{{-- ===== Rekap Belanja per Supplier ===== --}}
<div class="card shadow-sm border-0">
    <div class="card-body">
        <h6 class="fw-semibold mb-3"><i class="bi bi-truck"></i> Rekap Belanja per Supplier</h6>
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead>
                    <tr>
