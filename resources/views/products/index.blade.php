        ...
        <form method="GET" class="row g-2 mb-3">
            <div class="col-md-5">
                <div class="input-group">
                    ...
                    <input type="text" name="q" value="{{ $q }}" placeholder="Cari nama / kode produk..." class="form-control">
                </div>
            </div>
            <div class="col-md-3">
                ...
                <tbody>
                    @forelse ($products as $i => $p)
                        <tr class="{{ ! $p->is_active ? 'table-secondary' : '' }}">
                            ...
                            <td class="text-end">
                                <a href="{{ route('products.show', $p) }}" class="btn btn-sm btn-outline-secondary" title="Lihat detail">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </td>
                        </tr>
